...
function Logo(props: React.HTMLAttributes<SVGElement>) {
  return (
    <svg className={ `${css.svg}${props.className ? ' '+props.className : ''}` } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="40">
